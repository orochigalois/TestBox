...
#define LCD_XSIZE      		(GLCD_X_SIZE)   /* X-resolution of LCD, Logical coor. */
#define LCD_YSIZE      		(GLCD_Y_SIZE)   /* Y-resolution of LCD, Logical coor. */
...
#define LCD_SWAP_RB             (1)  //是否交换蓝色分量和红色分量,1为不交换


#define LCD_CONTROLLER  		-2//1375
#define LCD_SIMCONTROLLER
