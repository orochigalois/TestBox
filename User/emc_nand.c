...
void EMC_NAND_Test(void)
{
	...
	{	
		...
		{
			TxBuffer[index] = (uint32_t)0x22345678;
		}
...
/*=============================================================================
DESCRIPTION: EMC_NAND_EraseBlock
...
=============================================================================*/
uint32_t EMC_NAND_EraseSingleBlock(uint16_t Index)
{
  *(volatile uint8_t *)(NAND_FLASH_START_ADDR | CMD_AREA) = NAND_CMD_ERASE0;
  
  *(volatile uint8_t *)(NAND_FLASH_START_ADDR | ADDR_AREA) = ADDR_1st_CYCLE(Index);  
  *(volatile uint8_t *)(NAND_FLASH_START_ADDR | ADDR_AREA) = ADDR_2nd_CYCLE(Index);  
...
/*=============================================================================
DESCRIPTION: EMC_NAND_WriteSinglePage

PARAMETERS:uint8_t *pBuffer  
             uint16_t Index    
RETURN VALUE: 

DESIGN INFORMATION: alex 2014/1/26
=============================================================================*/
uint32_t EMC_NAND_WriteSinglePage(uint8_t *pBuffer, uint16_t Index)
{
...
uint32_t EMC_NAND_ReadSinglePage(uint8_t *pBuffer, uint16_t Index)
{
